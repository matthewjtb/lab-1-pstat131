...
# arrived >2 hr late, didn't leave late
flights %>% filter(arr_delay > 120 & dep_delay <= 0)

# delayed >= 1 hr, made up 30 min in flight
flights %>% filter(dep_delay >= 60 & dep_delay - arr_delay >= 30)

# departed between midnight at 6am
...
flights %>% select(dep_time, dep_delay, dep_time, arr_delay)
